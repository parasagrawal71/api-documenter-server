...
const { isObject, isEmptyObject, isString, isArray, isEmptyArray, deepObject } = require("./functions");
...
const commonLogFormat = (log, isConsoleLog) => {
  ...
  if (level && level.includes("request")) {
    ...
    const firstLineOfRequestLog = `${firstHalfOfFirstLineOfLog} : ${req.method} ${
